...
class Analyzer():
    ...
    def analyze(self,filename):
        ...
        self.draw_position_graph("Position", 2, "Position Data", [18,8,65])
        self.draw_VelAcc_graph("Velocity and Acceleration", 20, 0, "Velocity and Acceleration Data", [22,5,55])
    ...
    def draw_VelAcc_graph(self, title, vertical_threshold_vel, vertical_threshold_Acc, Window_name, fig_dimension):
        ...
        self.gui.add_graph(self.acceleration_dataFrame, vertical_threshold_Acc, "Acceleration(Degrees/s^2)", "mm/s^2" ,fig_dimension, hori_thresh=100)
        self.gui.add_slider()
        # Run GUI
        self.gui.mainloop()
